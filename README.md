...
| Tags | Layers | Size |
|-|-|-|
| `3.10`, `3.10-alpine`, `3`, `3-alpine`, `latest` | ![](https://badgen.net/docker/layers/emmercm/flexget/3.10?icon=docker&label=layers) | ![](https://badgen.net/docker/size/emmercm/flexget/3.10?icon=docker&label=size) |
